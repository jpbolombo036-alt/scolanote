...
ALTER TABLE subjects ADD CONSTRAINT IF NOT EXISTS fk_subjects_school_id FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS idx_subjects_school_id ON subjects(school_id);

-- Levels
ALTER TABLE levels ADD COLUMN IF NOT EXISTS school_id BIGINT;
ALTER TABLE levels ADD CONSTRAINT IF NOT EXISTS fk_levels_school_id FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE;
...
ALTER TABLE sections ADD CONSTRAINT IF NOT EXISTS fk_sections_school_id FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE;
...
ALTER TABLE options ADD CONSTRAINT IF NOT EXISTS fk_options_school_id FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE;
...
ALTER TABLE trimesters ADD CONSTRAINT IF NOT EXISTS fk_trimesters_school_id FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE;
...
ALTER TABLE periods ADD CONSTRAINT IF NOT EXISTS fk_periods_school_id FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE;
...
ALTER TABLE assessment_types ADD CONSTRAINT IF NOT EXISTS fk_assessment_types_school_id FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE;
...
ALTER TABLE user_roles ADD CONSTRAINT IF NOT EXISTS fk_user_roles_school_id FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE;
